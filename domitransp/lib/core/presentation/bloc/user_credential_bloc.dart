...
class UserCredentialBloc extends Bloc<UserCredentialEvent, UserCredentialState> {
  UserRepository userRepository;
  UserCredentialBloc({required this.userRepository}) : super(UserCredentialInitial()) {
    on<AppStarted>(_mapStarted);
  }

  Future<void> _mapStarted(AppStarted event, Emitter<UserCredentialState> emit) async{
    print('Entre al bloc');
